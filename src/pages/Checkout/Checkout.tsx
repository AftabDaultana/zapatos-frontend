...
export default function Checkout() {
  ...
  const closeAlertModal = () => {
    const shouldNavigateHome = alertModal.type === "success";
              ...
              <section>
                  ...
                  onSubmit={(e) => {
                    ...
                    if (!formData.billingAddress.country) {
                      showAlertModal(
                        ...
                        "Please select a billing country before placing your order.",
                      );
                      return;
                    }
                    ...
                    if (!formData.shippingAddress.country) {
                      showAlertModal(
                        ...
                        "Please select a shipping country before placing your order.",
                      );
                      return;
                    }
                    ...
                    if (checkoutItems.length === 0) {
                      showAlertModal(
                        "error",
                        "Your Cart Is Empty",
                        "Please add at least one product to your cart before placing your order.",
                      );
                      return;
                    }
                ...
                >
                  ...
                  <Button
                    type="submit"
                    variant="dark"
                    className="mt-8 w-full px-6 py-4 text-sm font-medium"
                  >
                    PLACE ORDER
                  </Button>
                </form>
